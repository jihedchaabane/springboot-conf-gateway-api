pipeline {
    ...
    environment {
        ...
        MODULE_PATH = 'springboot-conf-gateway-api'
        // Nom de l'image Docker
        DOCKER_IMAGE = 'jihed123/springboot-conf-gateway-api:0.0.1-SNAPSHOT'
        // Nom du conteneur
        CONTAINER_NAME = 'container-springboot-conf-gateway-api'
